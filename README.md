...
| `update`  | `User.update('', {'name' : "abc"})` | updates attribute of an object             |
| `destroy` | `User.destroy('')`                         | destroys specified object                  |
| `show`    | `User.show('')`                            | retrieve an object from a file, a database |
